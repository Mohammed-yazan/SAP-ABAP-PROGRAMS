...
*  PROCESS
  START-OF-SELECTION.
  SELECT LIFNR LAND1 NAME1 INTO TABLE ITAB1 FROM LFA1 WHERE LIFNR IN VENDOR.
   IF NOT ITAB1 IS INITIAL.
     SELECT LIFNR ORT01 REGIO STRAS
        INTO TABLE ITAB2 FROM
        LFA1 FOR ALL ENTRIES IN
        ITAB1 WHERE LIFNR EQ ITAB1-LIFNR.
  IF NOT ITAB2 IS INITIAL.
    SELECT LIFNR BUKRS AKONT ERDAT INTO TABLE ITAB3 FROM LFB1 FOR ALL ENTRIES IN ITAB2 WHERE LIFNR EQ ITAB2-LIFNR.
  ENDIF.
  IF ITAB3 IS INITIAL.
    MESSAGE S002.
    ELSE.
      PERFORM SUBR_FIELCAT.
      PERFORM SUBR_OUTPUT.
  ENDIF.
  ENDIF.
...
*  OUTPUT
  ...
  FORM SUBR_FIELCAT .
   ...
   WAFCAT3-COL_POS   = '3'.
   WAFCAT3-SELTEXT_M = 'ACCOUNT IN G/L'.
   APPEND WAFCAT3 TO ITFCAT3.
   CLEAR WAFCAT3.
