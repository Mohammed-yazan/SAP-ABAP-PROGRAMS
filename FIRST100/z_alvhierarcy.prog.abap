...
*&      Form  SUBR_OPENSQL
FORM SUBR_OPENSQL.
  SELECT VBELN NETWR WAERK INTO TABLE ITAB1 FROM VBAK WHERE ERDAT IN DATE.
  IF NOT ITAB1 IS INITIAL.
    SELECT VBELN POSNR MATNR INTO TABLE ITAB2 FROM VBAP FOR ALL ENTRIES IN ITAB1  WHERE VBELN EQ ITAB1-VBELN.
  ELSE.
    MESSAGE S003.
  ENDIF.
ENDFORM.
